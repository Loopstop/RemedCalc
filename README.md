...
3. Faça push da branch `work` ou rode o workflow manualmente em **Actions → Deploy calculadora to GitHub Pages**.
...
## Se aparecer só o texto da página inicial
...
3. Rode o workflow **Deploy calculadora to GitHub Pages** em **Actions** ou faça push na branch configurada.
...
- Rodapé central com `Versão: histórico local · v2`.
